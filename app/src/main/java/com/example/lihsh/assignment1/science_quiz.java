...
public class science_quiz extends AppCompatActivity {
    ...
    private void updateQuestion(){
        if(correct + wrong == 3) {
            Intent i = new Intent(science_quiz.this, congratulation_screen.class);
    ...
    private void checkAnswer(boolean pressedTrue){
        ...
        if(pressedTrue == isTrue){
            Toast.makeText(science_quiz.this,"Correct answer!",Toast.LENGTH_LONG).show();
            correct++;

        }else{
            Toast.makeText(science_quiz.this,"Wrong answer!",Toast.LENGTH_LONG).show();
            wrong++;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_giveUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder1 = new AlertDialog.Builder(science_quiz.this);
